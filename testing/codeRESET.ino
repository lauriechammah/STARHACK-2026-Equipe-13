    ...
    if (IrReceiver.decodedIRData.protocol != 0 &&
      ...
      if (cmd == 0x45) {
        ...
        if (chiffre >= 0 && chiffre <= 9) {
          ...
          // Garde 3 derniers chiffres avant d'ajouter le nouveau
          ...
          if (saisieIR.length() == 4) {
            // 9999 = RESET toujours en priorité
            if (saisieIR == "9999") {
              doReset();
              ...
              // Pas peutProgrammer et pas 9999 : vide saisie
              saisieIR = "";
            }
          }
        }
